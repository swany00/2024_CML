...
file_paths = {
    ...
    'rx5day': '/root/notenotenote/rx5day_1991-2020.nc',
    'cwd': '/root/notenotenote/cwd_era5_1991-2020.nc',
    'cdd': '/root/notenotenote/cdd_era5_1991-2020.nc'
}

# 일부 해상도만 사용
sampling_interval = 5  # 샘플링 간격, 숫자를 조정하여 해상도를 줄임
climate_variables = {}

for var, path in file_paths.items():
    ds = xr.open_dataset(path, decode_times=False)
    # 해상도 축소
    climate_variables[var] = ds[var].values[:, ::sampling_interval, ::sampling_interval]

# production_index_values 해상도 축소
production_index_values = production_index_values[:, ::sampling_interval, ::sampling_interval]
    ...
    for lon in range(lon_len):
        ...
        for var, data in climate_variables.items():
            ...
            if len(valid_climate_data) > 1:  # 최소 2개의 유효 데이터가 있어야 회귀 분석 가능
                ...
                model.fit(valid_climate_data.reshape(-1, 1), valid_production_index_values)
